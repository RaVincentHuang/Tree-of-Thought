...
def solve(args, task, idx, to_print=True):
    ...
    # 存储tot树形结构到json中
    file_name = f'./CJL_Logs/Json/{args.task}-{idx}_{args.backend}_{args.temperature}_{args.method_generate}{args.n_generate_sample}_{args.method_evaluate}{args.n_evaluate_sample}_{args.method_select}{args.n_select_sample}.json'
    os.makedirs(os.path.dirname(file_name), exist_ok=True)  #如果不存在，创建这个文件路径
    save_tree_to_json(tree, file_name)
